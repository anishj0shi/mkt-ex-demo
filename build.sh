...
createInKyma()
{
    log "Deploying Container acjoshi/mkt-ex to Kyma environment \"$1\"." green
...
log "2 Setup docker-credential-helper as mentioned in https://github.com/docker/docker-credential-helpers" yellow

log "docker-credential-helper will help you push your docker image to a docker registry, from where Kyma picks it up for deployment" yellow
...
#docker build -t acjoshi/mkt-ex .

#echo "Step 3: Pushing docker image acjoshi/mkt-ex to docker hub" green

#docker push acjoshi/mkt-ex
