...
/**
 * Template class to represent entity navigation links of {@link com.sap.demo.vdm.namespaces.mktcampaignsrv.ActualSpend ActualSpend} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.demo.vdm.namespaces.mktcampaignsrv.link.ActualSpendLink ActualSpendLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class ActualSpendOneToOneLink<ObjectT extends VdmObject<?> >
    extends ActualSpendLink<ObjectT>
    implements OneToOneLink<ActualSpend, ObjectT>
{
     ...
     */
    public ActualSpendOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<ActualSpend> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<ActualSpend>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
