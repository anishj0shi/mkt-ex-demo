...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.demo.vdm.namespaces.mktcampaignsrv.AssignedTargetGroupEntity AssignedTargetGroupEntity}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class AssignedTargetGroupEntityField<FieldT >
    extends EntityField<AssignedTargetGroupEntity, FieldT>
    implements AssignedTargetGroupEntitySelectable
{
     ...
     */
    public AssignedTargetGroupEntityField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public AssignedTargetGroupEntityField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
