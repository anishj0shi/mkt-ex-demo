...
package com.sap.demo.vdm.namespaces.mkttargetgroupsrv.field;
...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.demo.vdm.namespaces.mkttargetgroupsrv.TargetGroupInteractionContactEntity TargetGroupInteractionContactEntity}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class TargetGroupInteractionContactEntityField<FieldT >
    extends EntityField<TargetGroupInteractionContactEntity, FieldT>
    implements TargetGroupInteractionContactEntitySelectable
{
     ...
     */
    public TargetGroupInteractionContactEntityField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public TargetGroupInteractionContactEntityField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
