...
/**
 * Template class to represent entity navigation links of {@link com.sap.demo.vdm.namespaces.mktcmpgnsuccessimportsrv.Success Success} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.demo.vdm.namespaces.mktcmpgnsuccessimportsrv.link.SuccessLink SuccessLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class SuccessOneToOneLink<ObjectT extends VdmObject<?> >
    extends SuccessLink<ObjectT>
    implements OneToOneLink<Success, ObjectT>
{
     ...
     */
    public SuccessOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<Success> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<Success>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
