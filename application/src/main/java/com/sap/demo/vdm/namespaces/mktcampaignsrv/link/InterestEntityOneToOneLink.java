...
/**
 * Template class to represent entity navigation links of {@link com.sap.demo.vdm.namespaces.mktcampaignsrv.InterestEntity InterestEntity} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.demo.vdm.namespaces.mktcampaignsrv.link.InterestEntityLink InterestEntityLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class InterestEntityOneToOneLink<ObjectT extends VdmObject<?> >
    extends InterestEntityLink<ObjectT>
    implements OneToOneLink<InterestEntity, ObjectT>
{
     ...
     */
    public InterestEntityOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<InterestEntity> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<InterestEntity>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
