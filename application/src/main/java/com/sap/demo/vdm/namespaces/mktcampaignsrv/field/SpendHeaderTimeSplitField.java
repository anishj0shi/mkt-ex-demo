...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.demo.vdm.namespaces.mktcampaignsrv.SpendHeaderTimeSplit SpendHeaderTimeSplit}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class SpendHeaderTimeSplitField<FieldT >
    extends EntityField<SpendHeaderTimeSplit, FieldT>
    implements SpendHeaderTimeSplitSelectable
{
     ...
     */
    public SpendHeaderTimeSplitField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public SpendHeaderTimeSplitField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
