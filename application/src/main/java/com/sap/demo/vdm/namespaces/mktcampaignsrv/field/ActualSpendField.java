...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.demo.vdm.namespaces.mktcampaignsrv.ActualSpend ActualSpend}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class ActualSpendField<FieldT >
    extends EntityField<ActualSpend, FieldT>
    implements ActualSpendSelectable
{
     ...
     */
    public ActualSpendField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public ActualSpendField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
