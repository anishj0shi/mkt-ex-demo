...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.demo.vdm.namespaces.mktcampaignsrv.TeamMemberEntity TeamMemberEntity}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class TeamMemberEntityField<FieldT >
    extends EntityField<TeamMemberEntity, FieldT>
    implements TeamMemberEntitySelectable
{
     ...
     */
    public TeamMemberEntityField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public TeamMemberEntityField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
