...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.demo.vdm.namespaces.mkttargetgroupsrv.TargetGroupEntity TargetGroupEntity}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class TargetGroupEntityField<FieldT >
    extends EntityField<TargetGroupEntity, FieldT>
    implements TargetGroupEntitySelectable
{
     ...
     */
    public TargetGroupEntityField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public TargetGroupEntityField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
