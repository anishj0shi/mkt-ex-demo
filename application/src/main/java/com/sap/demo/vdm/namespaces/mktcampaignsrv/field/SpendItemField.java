...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.demo.vdm.namespaces.mktcampaignsrv.SpendItem SpendItem}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class SpendItemField<FieldT >
    extends EntityField<SpendItem, FieldT>
    implements SpendItemSelectable
{
     ...
     */
    public SpendItemField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public SpendItemField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
