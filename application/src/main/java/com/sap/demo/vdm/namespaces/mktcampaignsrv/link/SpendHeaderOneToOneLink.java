...
/**
 * Template class to represent entity navigation links of {@link com.sap.demo.vdm.namespaces.mktcampaignsrv.SpendHeader SpendHeader} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.demo.vdm.namespaces.mktcampaignsrv.link.SpendHeaderLink SpendHeaderLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class SpendHeaderOneToOneLink<ObjectT extends VdmObject<?> >
    extends SpendHeaderLink<ObjectT>
    implements OneToOneLink<SpendHeader, ObjectT>
{
     ...
     */
    public SpendHeaderOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<SpendHeader> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<SpendHeader>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
