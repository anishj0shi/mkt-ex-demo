...
package com.sap.demo.vdm.namespaces.mktcmpgnsuccessimportsrv.field;
...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.demo.vdm.namespaces.mktcmpgnsuccessimportsrv.Success Success}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class SuccessField<FieldT >
    extends EntityField<Success, FieldT>
    implements SuccessSelectable
{
     ...
     */
    public SuccessField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public SuccessField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
