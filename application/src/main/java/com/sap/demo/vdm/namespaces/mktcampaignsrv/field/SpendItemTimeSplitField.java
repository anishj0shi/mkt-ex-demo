...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.demo.vdm.namespaces.mktcampaignsrv.SpendItemTimeSplit SpendItemTimeSplit}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class SpendItemTimeSplitField<FieldT >
    extends EntityField<SpendItemTimeSplit, FieldT>
    implements SpendItemTimeSplitSelectable
{
     ...
     */
    public SpendItemTimeSplitField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public SpendItemTimeSplitField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
