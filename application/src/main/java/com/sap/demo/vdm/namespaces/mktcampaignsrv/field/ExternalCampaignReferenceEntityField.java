...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.demo.vdm.namespaces.mktcampaignsrv.ExternalCampaignReferenceEntity ExternalCampaignReferenceEntity}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class ExternalCampaignReferenceEntityField<FieldT >
    extends EntityField<ExternalCampaignReferenceEntity, FieldT>
    implements ExternalCampaignReferenceEntitySelectable
{
     ...
     */
    public ExternalCampaignReferenceEntityField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public ExternalCampaignReferenceEntityField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
