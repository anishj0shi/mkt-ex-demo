...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.demo.vdm.namespaces.mktcampaignsrv.SpendHeader SpendHeader}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class SpendHeaderField<FieldT >
    extends EntityField<SpendHeader, FieldT>
    implements SpendHeaderSelectable
{
     ...
     */
    public SpendHeaderField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public SpendHeaderField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
