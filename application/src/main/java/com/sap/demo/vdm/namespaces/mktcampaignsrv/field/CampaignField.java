...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.demo.vdm.namespaces.mktcampaignsrv.Campaign Campaign}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class CampaignField<FieldT >
    extends EntityField<Campaign, FieldT>
    implements CampaignSelectable
{
     ...
     */
    public CampaignField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public CampaignField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
